...
urlpatterns = [
    ...
    path('group/background', GroupChatBackgroundView.as_view(), name='group_chat_background'),
    ...
    path('group/mutes', GroupChatMuteView.as_view(), name='group_chat_mutes'),
    ...
    path('submissions/invites', SubmissionInviteView.as_view(), name='submission_invite'),
    path('submissions/invite', SubmissionInviteDetailView.as_view(), name='submission_invite_detail'),
    ...
    path('submissions/delete', SubmissionDeleteView.as_view(), name='submission_delete'),
]
