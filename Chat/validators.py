...
class ChatErrors:
    ...
    SUBMISSION_INVITE_FORBIDDEN = Error(_('You are not allowed to send or accept this submission invite'))
    SUBMISSION_INVITE_CLOSED = Error(_('This submission invite is no longer available'))
    SUBMISSION_INVITE_EXPIRED = Error(_('This submission invite has expired'))
    SUBMISSION_ROLE_CONFLICT = Error(_('You have already joined this submission with another role'))
    SUBMISSION_ROLE_INVALID = Error(_('Invalid submission member role'))
