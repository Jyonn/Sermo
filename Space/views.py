...
class SpaceAdminSettingsView(View):
    ...
    @analyse.json(
        ...
        SpaceParams.space_group_enabled,
        SpaceParams.square_free_post_enabled,
        SpaceParams.submission_enabled,
        SpaceParams.square_explore_enabled,
        SpaceParams.qq_binding_enabled,
    ...
    def post(self, request: Request):
        space = request.space.set_admin_settings(
            ...
            space_group_enabled=request.json.space_group_enabled,
            square_free_post_enabled=request.json.square_free_post_enabled,
            submission_enabled=request.json.submission_enabled,
            square_explore_enabled=request.json.square_explore_enabled,
            qq_binding_enabled=request.json.qq_binding_enabled,
