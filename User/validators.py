...
class UserErrors:
    ...
    WELCOME_MESSAGES_LIMIT = Error(message=_('Welcome message limit reached'), code=Code.BadRequest)
    ...
    FEATURE_DISCOVERY_INVALID = Error(message=_('Invalid feature discovery'), code=Code.BadRequest)
...
class UserValidator:
    ...
    CHAT_BACKGROUND_THEMES = {
        ...
        'aurora-sky', 'hologram', 'frienden-night', 'frienden-garden', 'starry-night', 'noir-film', 'custom',
    }
