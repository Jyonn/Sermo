...
def _reward(reward_id, level, category, title, rarity, asset_key=None, capability_key=None, status='available'):
    return {
        'id': reward_id,
        'level': level,
        'category': category,
...
LEVEL_REWARDS = {
    ...
    2: [_reward('capability.image', 2, 'capability', '发送图片', 'uncommon', capability_key='send_image'), _reward('background.paper', 2, 'background', '纸张背景', 'common', 'paper'), _reward('bubble.comic', 2, 'bubble', '漫画气泡', 'uncommon', 'comic'), _reward('frame.orbit', 2, 'frame', '轨道头像框', 'uncommon', 'orbit')],
    3: [_reward('capability.audio', 3, 'capability', '发送语音', 'uncommon', capability_key='send_audio'), _reward('capability.location', 3, 'capability', '分享位置', 'uncommon', capability_key='send_location'), _reward('identity.level_tag', 3, 'identity', '等级签', 'uncommon'), _reward('background.mint', 3, 'background', '薄荷背景', 'common', 'mint'), _reward('frame.polaroid', 3, 'frame', '拍立得头像框', 'uncommon', 'polaroid')],
    ...
    6: [_reward('capability.welcome', 6, 'capability', '自定义欢迎语与广场招呼', 'rare', capability_key='welcome_message'), _reward('background.zen', 6, 'background', '禅意背景', 'uncommon', 'zen'), _reward('bubble.zen', 6, 'bubble', '禅意气泡', 'uncommon', 'zen'), _reward('frame.butterfly', 6, 'frame', '蝴蝶头像框', 'rare', 'butterfly')],
    ...
    13: [_reward('background.rain', 13, 'background', '雨幕背景', 'rare', 'rain'), _reward('background.galaxy', 13, 'background', '星系背景', 'epic', 'galaxy'), _reward('bubble.mosaic', 13, 'bubble', '马赛克气泡', 'epic', 'mosaic'), _reward('frame.mechanical', 13, 'frame', '机械头像框', 'epic', 'mechanical')],
    14: [_reward('background.aurora_sky', 14, 'background', '极光天空背景', 'epic', 'aurora-sky'), _reward('background.linen', 14, 'background', '亚麻背景', 'epic', 'linen'), _reward('background.terrazzo', 14, 'background', '水磨石背景', 'epic', 'terrazzo')],
    15: [_reward('background.blueprint', 15, 'background', '蓝图背景', 'epic', 'blueprint'), _reward('background.newsprint', 15, 'background', '新闻纸背景', 'epic', 'newsprint'), _reward('background.hologram', 15, 'background', '全息背景', 'epic', 'hologram')],
    16: [_reward('background.arcade', 16, 'background', '街机背景', 'legendary', 'arcade'), _reward('background.jazz', 16, 'background', '爵士背景', 'legendary', 'jazz'), _reward('bubble.niko', 16, 'bubble', 'Niko 气泡', 'legendary', 'niko'), _reward('frame.niko', 16, 'frame', 'Niko Run 头像框', 'legendary', 'niko-run'), _reward('growth.report', 16, 'identity', '成长报告', 'legendary', status='planned')],
    17: [_reward('background.spaceport', 17, 'background', '太空港背景', 'legendary', 'spaceport'), _reward('background.candy', 17, 'background', '糖果背景', 'legendary', 'candy'), _reward('bubble.fufu', 17, 'bubble', 'Fufu 气泡', 'legendary', 'fufu'), _reward('frame.fufu', 17, 'frame', 'Fufu Wave 头像框', 'legendary', 'fufu-wave'), _reward('frame.collection', 17, 'identity', '稀有头像框系列入口', 'legendary', status='planned')],
