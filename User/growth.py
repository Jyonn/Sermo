...
LEVEL_REWARDS = {
    ...
    17: [_reward('background.spaceport', 17, 'background', '太空港背景', 'epic', 'spaceport'), _reward('background.candy', 17, 'background', '糖果背景', 'rare', 'candy'), _reward('bubble.fufu', 17, 'bubble', 'Fufu 气泡', 'epic', 'fufu'), _reward('frame.fufu', 17, 'frame', 'Fufu Wave 头像框', 'legendary', 'fufu-wave'), _reward('frame.collection', 17, 'identity', '头像框收藏入口', 'epic', status='planned')],
