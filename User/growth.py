...
LEVEL_REWARDS = {
    ...
    6: [_reward('capability.welcome', 6, 'capability', '自定义欢迎语与广场招呼', 'rare', capability_key='welcome_message'), _reward('capability.sticker', 6, 'capability', '制作个人表情包', 'rare', capability_key='create_sticker'), _reward('background.zen', 6, 'background', '枯山水背景', 'rare', 'zen'), _reward('bubble.zen', 6, 'bubble', '禅意气泡', 'uncommon', 'zen')],
    ...
    9: [_reward('background.mosaic', 9, 'background', '马赛克背景', 'rare', 'mosaic'), _reward('bubble.hero', 9, 'bubble', '英雄气泡', 'rare', 'hero'), _reward('frame.papercut', 9, 'frame', '剪纸头像框', 'uncommon', 'papercut')],
    10: [_reward('bubble.bauhaus', 10, 'bubble', '包豪斯气泡', 'rare', 'bauhaus')],
    11: [_reward('bubble.receipt', 11, 'bubble', '小票气泡', 'rare', 'receipt')],
    12: [_reward('capability.nickname_7', 12, 'capability', '昵称每 7 天可改', 'epic', capability_key='rename_nickname'), _reward('bubble.dragon', 12, 'bubble', '游龙气泡', 'epic', 'dragon'), _reward('profile.card_theme', 12, 'identity', '个人名片主题系统', 'legendary', status='planned')],
    13: [_reward('bubble.mosaic', 13, 'bubble', '马赛克气泡', 'epic', 'mosaic'), _reward('frame.mechanical', 13, 'frame', '机械头像框', 'uncommon', 'mechanical')],
