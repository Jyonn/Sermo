...
from User.views import (
    ...
    InstantNotificationEndpointView,
    InstantNotificationEndpointCodeView,
    InstantNotificationEndpointDetailView,
    NotificationTopicPreferenceView,
    NotificationEventView,
    UserStateEventBaselineView,
    UserStateEventSyncView,
    ...
    ContactUnbindView,
    QQIdentityView,
    QQIdentityFromVerifiedEmailView,
    QQIdentityCodeView,
    UserGrowthEventView,
    UserGrowthAcknowledgementView,
    UserFeatureDiscoveryView,
...
urlpatterns = [
    ...
    path('me/feature-discoveries', UserFeatureDiscoveryView.as_view(), name='user feature discoveries'),
    ...
    path('me/instant-endpoints', InstantNotificationEndpointView.as_view(), name='instant notification endpoints'),
    path('me/instant-endpoints/code', InstantNotificationEndpointCodeView.as_view(), name='instant notification endpoint code'),
    path('me/instant-endpoints/<int:endpoint_id>', InstantNotificationEndpointDetailView.as_view(), name='instant notification endpoint detail'),
    path('me/notification-topics', NotificationTopicPreferenceView.as_view(), name='notification topics'),
    path('me/notification-events', NotificationEventView.as_view(), name='notification events'),
    path('me/state-events', UserStateEventSyncView.as_view(), name='user state events'),
    path('me/state-events/baseline', UserStateEventBaselineView.as_view(), name='user state event baseline'),
    ...
    path('me/qq-identity', QQIdentityView.as_view(), name='qq identity'),
    path('me/qq-identity/from-verified-email', QQIdentityFromVerifiedEmailView.as_view(), name='qq identity from verified email'),
    path('me/qq-identity/code', QQIdentityCodeView.as_view(), name='qq identity code'),
