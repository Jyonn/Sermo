...
class GrowthRuleTests(SimpleTestCase):
    ...
    def test_reward_rarity_follows_the_product_reward_audit(self):
        ...
        self.assertEqual(rewards['bubble.zen']['rarity'], 'common')
        self.assertEqual(rewards['bubble.mosaic']['rarity'], 'common')
        self.assertEqual(rewards['bubble.newspaper']['rarity'], 'common')
        self.assertEqual(rewards['bubble.hero']['rarity'], 'uncommon')
        self.assertEqual(rewards['bubble.bauhaus']['rarity'], 'uncommon')
        self.assertEqual(rewards['bubble.dragon']['rarity'], 'rare')
